...
def main():
    ...
    # FIX: Replaced inplace=True with direct assignment
    aligned_returns = aligned_returns.replace([np.inf, -np.inf], np.nan)
    aligned_momentum = aligned_momentum.replace([np.inf, -np.inf], np.nan)
    aligned_returns = aligned_returns.fillna(0.0)
    aligned_momentum = aligned_momentum.fillna(0.0)
